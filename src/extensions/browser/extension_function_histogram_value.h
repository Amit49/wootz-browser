...
enum HistogramValue {
  ...
  WOOTZ_INFO = 1890,
  HELLOWORLD_SAYHELLO = 1891,
  WOOTZ_HELLOWORLD = 1892,
  WOOTZ_SHOWCONSENTDIALOGANDMAYBESTARTSERVICE = 1893,
  WOOTZ_SHOWDIALOG = 1894,
  WOOTZ_LOG = 1895,
  WOOTZ_SELECT_CHAIN = 1896,
  WOOTZ_CREATE_WALLET = 1897,
  WOOTZ_UNLOCK_WALLET = 1898,
  WOOTZ_LOCK_WALLET = 1899,
  WOOTZ_IS_LOCKED = 1900,
