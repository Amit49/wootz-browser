...
enum HistogramValue {
  ...
  WOOTZ_INFO = 1890,
  WOOTZ_CREATE_WALLET = 1891,
  WOOTZ_UNLOCK_WALLET = 1892,
  WOOTZ_LOCK_WALLET = 1893,
  WOOTZ_IS_LOCKED = 1894,
  WOOTZ_GET_ALL_ACCOUNTS = 1895,
  WOOTZ_GET_ACCOUNT_BALANCE = 1896,
  WOOTZ_SIGN_MESSAGE = 1897,
  WOOTZ_HELLOWORLD = 1898,
  WOOTZ_SHOWDIALOG = 1899,
