...
type Props = {
  txSimulation: WootzWallet.SolanaSimulationResponse
...
export const SignSimulatedTransactionPanel = ({
  ...
  const [isCriticalWarningPopupOpen, setIsCriticalWarningPopupOpen] =
    React.useState(
      txSimulation.action === WootzWallet.BlowfishSuggestedAction.kBlock
    )
          ...
          <>
            ...
            <SignPanelButtonRow>
              ...
              <NavButton
                buttonType={'danger'}
                minWidth='45%'
                text={getLocale('wootzWalletButtonContinue')}
                onSubmit={() => {
