...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_ETHEREUM_PROVIDER_IMPL_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_ETHEREUM_PROVIDER_IMPL_H_
...
#include "components/wootz_wallet/browser/eth_block_tracker.h"
#include "components/wootz_wallet/browser/eth_logs_tracker.h"
...
class EthereumProviderImpl final : public mojom::EthereumProvider,
 ...
 private:
  ...
  std::unique_ptr<WootzWalletProviderDelegate> delegate_;
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_ETHEREUM_PROVIDER_IMPL_H_
