...
#include "components/wootz_wallet/browser/internal/orchard_bundle_manager.h"
#include "components/wootz_wallet/browser/test_utils.h"
#include "components/wootz_wallet/common/hex_utils.h"
#endif
 ...
 public:
  ...
  void SetUp() override {
    feature_list_.InitAndEnableFeatureWithParameters(
        features::kWootzWalletZCashFeature,
        {{"zcash_shielded_transactions_enabled", "true"}});
    wootz_wallet::RegisterProfilePrefs(prefs_.registry());
    wootz_wallet::RegisterLocalStatePrefs(local_state_.registry());
    keyring_service_ =
