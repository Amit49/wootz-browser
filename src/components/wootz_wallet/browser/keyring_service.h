...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_KEYRING_SERVICE_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_KEYRING_SERVICE_H_
...
class KeyringService : public mojom::KeyringService {
 ...
 private:
  ...
  FRIEND_TEST_ALL_PREFIXES(KeyringServiceUnitTest, RestoreLegacyWootzWallet);
  ...
  friend class WootzWalletServiceUnitTest;
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_KEYRING_SERVICE_H_
