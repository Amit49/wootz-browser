...
public class WootzPermissionAccountsListAdapter
        extends RecyclerView.Adapter<WootzPermissionAccountsListAdapter.ViewHolder> {
    ...
    public enum Mode {
         ...
         *
         * @see WootzDappPermissionPromptDialog
         */
         ...
         *
         * @see org.chromium.chrome.browser.wootz_wallet.fragments.dapps.ConnectAccountFragment
         */
        ACCOUNT_CONNECTION
    }
    ...
    public WootzPermissionAccountsListAdapter(
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.wootz_wallet_accounts_list_item, parent, false);
            ...
            case ACCOUNT_CONNECTION -> {
                ...
                if (CoinType.SOL == mSelectedAccount.accountId.coin) {
                    connectionButtonText =
                            hasPermission
                                    ? R.string.wootz_wallet_site_permissions_revoke
                                    : R.string.wootz_wallet_site_permissions_trust;
                } else {
                    if (hasPermission) {
                        if (isConnected) {
