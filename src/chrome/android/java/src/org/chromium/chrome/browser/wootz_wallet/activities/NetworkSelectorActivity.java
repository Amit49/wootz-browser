...
import org.chromium.chrome.browser.settings.WootzSettingsLauncherImpl;
import org.chromium.chrome.browser.settings.WootzWalletAddNetworksFragment;
...
public class NetworkSelectorActivity extends WootzWalletBaseActivity
    ...
    public static Intent createIntent(@NonNull final Context context) {
        Intent wootzNetworkSelectionIntent = new Intent(context, NetworkSelectorActivity.class);
        wootzNetworkSelectionIntent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
        return wootzNetworkSelectionIntent;
    }
    ...
    protected void triggerLayoutInflation() {
        ...
        mToolbar.setTitle(R.string.wootz_wallet_select_network_title);
    ...
    private void initState() {
        ...
        mSettingsLauncher = new WootzSettingsLauncherImpl();
    ...
    private void launchAddNetwork() {
        ...
        Intent intent =
                mSettingsLauncher.createSettingsActivityIntent(
                        this, WootzWalletAddNetworksFragment.class, fragmentArgs);
    ...
    private void updateNetworkUi(NetworkInfo networkInfo, boolean isSelected) {
        if (!isSelected) {
            Toast.makeText(
                            this,
                            getString(
                                    R.string.wootz_wallet_network_selection_error,
